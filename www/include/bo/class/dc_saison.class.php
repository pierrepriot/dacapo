...
/* [Begin patch] */
/* [End patch] */
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/dc_saison.class.php')  && (strpos(__FILE__,'/include/bo/class/dc_saison.class.php')===FALSE) ){
		include_once($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/dc_saison.class.php');
}else{
/*======================================

objet de BDD dc_saison :: class dc_saison

SQL mySQL:

DROP TABLE IF EXISTS dc_saison;
CREATE TABLE dc_saison
(
...
<class name="dc_saison" libelle="Saison" prefix="dc" display="nom" abstract="nom" >
<item name="id" type="int" length="11" isprimary="true" notnull="true" default="-1" list="true" order="true" />

<item name="nom" libelle="Saisie (année/année)" type="varchar" length="64" list="true" order="true" oblig="true" />
...
var $sMySql = "CREATE TABLE dc_saison
(
	dc_id			int (11) PRIMARY KEY not null,
	dc_nom			varchar (64),
	dc_desc			text (1024),
...
//
function getTable() { return("dc_saison"); }
function getClasse() { return("dc_saison"); }
...
if (!is_dir($_SERVER['DOCUMENT_ROOT']."/backoffice/dc_saison")){
	mkdir($_SERVER['DOCUMENT_ROOT']."/backoffice/dc_saison");
	$list = fopen($_SERVER['DOCUMENT_ROOT']."/backoffice/dc_saison/list_dc_saison.php", "w");
	$listContent = "<"."?php
