...
<item name="reglee" libelle="Réglée" type="int" length="2" default="1" list="true" order="true" option="bool" />

<item name="envoyee" libelle="Envoyée" type="int" length="2" default="0" list="true" order="true" option="bool" />
