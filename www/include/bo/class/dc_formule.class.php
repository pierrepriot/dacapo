...
/* [Begin patch] */
/* [End patch] */
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/dc_formule.class.php')  && (strpos(__FILE__,'/include/bo/class/dc_formule.class.php')===FALSE) ){
		include_once($_SERVER['DOCUMENT_ROOT'].'/include/bo/class/dc_formule.class.php');
}else{
/*======================================

objet de BDD dc_formule :: class dc_formule

SQL mySQL:

DROP TABLE IF EXISTS dc_formule;
CREATE TABLE dc_formule
(
...
<class name="dc_formule" libelle="Formule" prefix="dc" display="nom" abstract="tarif" >
...
<item name="tarif" libelle="Tarif" type="int" length="16" list="true" order="true" oblig="true" nohtml="true" />
...
var $sMySql = "CREATE TABLE dc_formule
(
	dc_id			int (11) PRIMARY KEY not null,
	dc_nom			varchar (64),
	dc_tarif			int (16),
...
function getListeChamps()
{
	...
	$laListeChamps[]=new dbChamp("Dc_tarif", "entier", "get_tarif", "set_tarif");
...
function get_tarif() { return($this->tarif); }
...
function set_tarif($c_dc_tarif) { return($this->tarif=$c_dc_tarif); }
...
//
function getTable() { return("dc_formule"); }
function getClasse() { return("dc_formule"); }
function getPrefix() { return(""); }
function getDisplay() { return("nom"); }
function getAbstract() { return("tarif"); }
...
if (!is_dir($_SERVER['DOCUMENT_ROOT']."/backoffice/dc_formule")){
	mkdir($_SERVER['DOCUMENT_ROOT']."/backoffice/dc_formule");
	$list = fopen($_SERVER['DOCUMENT_ROOT']."/backoffice/dc_formule/list_dc_formule.php", "w");
	$listContent = "<"."?php
